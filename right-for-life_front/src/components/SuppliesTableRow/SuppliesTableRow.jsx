...
const SuppliesTableRow = ({ isEdit, updateSupplie, deleteSupplie, itemData }) => {
  ...
  return (
    <tr>
      <td
        ...
        className={`border px-4 py-2 rounded-lg capitalize text-center bg-gray-400 ${isEdit && 'bg-orange-200'}`}
      ...
      <td
        contentEditable={isEdit}
        suppressContentEditableWarning
        className={`border px-4 py-2 rounded-lg text-center bg-gray-400 ${isEdit && 'bg-orange-200'}`}
