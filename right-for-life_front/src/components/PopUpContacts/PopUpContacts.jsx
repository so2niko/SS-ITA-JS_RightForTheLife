  ...
  return (
    <Modal isOpen style={style}>
      ...
      <section className="flex flex-wrap justify-center outline-none">
        <a href="tel:0932350370" className="flex flex-0 justify-center items-center w-16 h-16 m-2 bg-green-600 rounded-full">
          <i className={`fas fa-phone-alt fa-2x text-white`}></i>
        </a>
        <a href="viber://chat?number=0932350370">
          <ViberIcon className="m-2 cursor-pointer" size={65} round={true} />
        </a>
        <a href="https://web.telegram.org/#/im?p=u737945099_1624124500386583069" target="_blank" rel="noopener noreferrer">
          <TelegramIcon className="m-2 cursor-pointer" size={65} round={true} />
        </a>
        <a href="https://m.me/2943840722507275" target="_blank" rel="noopener noreferrer">
          <FacebookIcon className="m-2 cursor-pointer" size={65} round={true} />
        </a>
      </section>
    </Modal>
  );
